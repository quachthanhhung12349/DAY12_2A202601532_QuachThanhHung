...
class CostGuard:
    ...
    def spent(self, client_id: str, day: str | None = None) -> float:
        ...
        """
        spent = self.client.get(self._key(client_id, day))
    ...
    def record(self, client_id: str, cost: float, day: str | None = None) -> float:
        ...
        """
        total = self.client.incrbyfloat(self._key(client_id, day), cost)
        self.client.expire(self._key(client_id, day), KEY_TTL_SECONDS)
        return float(total)
